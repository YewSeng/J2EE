document.addEventListener("DOMContentLoaded", function () {
    const updateBatchButton = document.getElementById("updateBatchButton");

    if (updateBatchButton) {
        updateBatchButton.addEventListener("click", function (event) {
...
function submitForm() {
    ...
    // Submit the form
     document.getElementById("updateBatchButton").submit();
}
